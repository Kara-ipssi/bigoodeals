                ...
                <div class="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                    ...
                    @auth
                        <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                            ...
                            <div class="mt-6">
                                <a href="{{route('shop.checkout')}}" class="flex justify-center items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">{{__('Checkout')}}</a>
                            </div>
