<div class="relative">
    ...
    <div class="relative max-w-3xl mx-auto pb-96 px-4 text-center sm:pb-0 sm:px-6 lg:px-8">
        ...
        <div class="relative py-32">
            <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl md:text-6xl">BiGoo<span class="text-gray-300">D</span>eals</h1>
            <div class="mt-4 sm:mt-6">
            <a href="#" class="inline-block bg-indigo-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-indigo-700">{{__('Shop Collection')}}</a>
            </div>
        </div>
    </div>
